...
public class GunungAdapter extends RecyclerView.Adapter<GunungAdapter.GunungViewHolder> {
    ...
    private final List<GunungResponse.NamaGunung> gunungList;
    private final Context context;

    // Constructor
    public GunungAdapter(List<GunungResponse.NamaGunung> gunungList, Context context) {
    ...
    public void onBindViewHolder(GunungViewHolder holder, int position) {
        GunungResponse.NamaGunung gunung = gunungList.get(position);
